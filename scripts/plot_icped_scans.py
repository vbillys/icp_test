...
vertices2 =  getVertexFromGraph(f_handle2, 2433)
vertices =  getVertexFromGraph(f_handle, 2433, True)
vertices3 =  getVertexFromGraph(f_handle3, 2433, True)
...
ax.scatter ([x[0] for x in point_t],[x[1] for x in point_t], color='magenta', s=.3)
# fig.canvas.draw()
plt.show(True)
