...
g_pub_cloud_only_current_filtered = rospy.Publisher("ibeo_points_icp_only_current_filtered", PointCloud2)
...
def processPointCloudFiltered(msg):
  global g_points_new_filtered
  # g_point_cloud_built.header = header;
  # g_point_cloud_built.points = g_point_cloud_built.points + msg.points
  points_new_gen = pc2.read_points(msg, skip_nans=True, field_names=("x","y","z"))
  g_points_new_filtered = [ p for p in points_new_gen]
...
def talker():
  ...
  rospy.Subscriber('ibeo_points_filtered', PointCloud2, processPointCloudFiltered)
